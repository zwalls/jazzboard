...
- [x] Complex group gestures resolve tldraw's selected ancestor up front and use one all-or-nothing acquire/renew/release lease cohort; bounded jittered persistence retries prevent ordinary presence overlap from starving the document commit.
