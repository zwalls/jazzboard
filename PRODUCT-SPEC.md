...
| Exact first-party live-canvas framing with a short-lived screenshot clip | Participant | No | Yes, local-only | No |
| Actual inspection of captured preview pixels | Yes | No | Browser-host vision step after preview, not a WebMCP result | No preview tool |
